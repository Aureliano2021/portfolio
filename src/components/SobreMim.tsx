...
export const SobreMim = () => {
    return (
        ...
        <div className="flex flex-col-reverse lg:flex-row">
            <div className="flex-2/3 h-2/3 p-8 lg:p-16">
            ...
            <div className="w-full h-1/5 bg-cover bg-left md:flex1/3 lg:bg-top-left lg:h-screen" style={{ backgroundImage: "url('/media/sfrancisco-petrolina.jpg')" }}></div>
        </div>
        </motion.div>
    )
}